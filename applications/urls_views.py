...
urlpatterns = [
    ...
    path('<uuid:application_id>/status/', views_web.UpdateApplicationStatusView.as_view(), name='update_status'),
    path('<uuid:application_id>/rating/', views_web.UpdateApplicationRatingView.as_view(), name='update_rating'),
    path('<uuid:application_id>/resume/', views_web.ViewResumeView.as_view(), name='view_resume'),
]
